...
#load("C:/Dropbox/Rogerio/Formacao/Pos-Doc/Exercicios com PNAD 1968-1973/2-Analises/Ambiente - TESTE 19 - testando model_ols_rsubbins.RData")
load("E:/Dropbox-Ro/Dropbox/Rogerio/Formacao/Pos-Doc/Exercicios com PNAD 1968-1973/2-Analises/Ambiente - TESTE 19 - testando model_ols_rsubbins.RData")
...
model_ols_rsubbins <- function(formula, data_pnad,
...
betas_table_rsubbins_1000 <- model_ols_rsubbins(formula = formula,
                                           data_pnad = c1970_aggreg,
                                           groups = "municipalityCurrent",
                                           binSampleSize = 1000)

betas_table_rsubbins_2000 <- model_ols_rsubbins(formula = formula,
                                                data_pnad = c1970_aggreg,
                                                groups = "municipalityCurrent",
                                                binSampleSize = 2000)

betas_table_rsubbins_3000 <- model_ols_rsubbins(formula = formula,
                                                data_pnad = c1970_aggreg,
                                                groups = "municipalityCurrent",
                                                binSampleSize = 3000)
